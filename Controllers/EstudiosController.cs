...
namespace personapi_donet.Controllers
{
    public class EstudiosController : Controller
    {
        ...
        public EstudiosController(labdbContext context)
        {
            _context = context;
        }
        ...
        {
            var labdbContext = _context.Estudios.Include(e => e.CcPerNavigation).Include(e => e.IdProfNavigation);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'labdbContext.Estudios'  is null.");
            }
            var estudio = await _context.Estudios.FindAsync(id);
            if (estudio != null)
            {
